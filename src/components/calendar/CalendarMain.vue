            ...
            <div class="w-full mt-5 px-2 md:px-4">
                <Calendar :events="events">
                    <template #eventDialog="props">
                        <div v-if="props.eventDialogData && props.eventDialogData.title" class="p-4 flex justify-center bg-gray-200 border border-gray-400 rounded-md">
                            <div>
                                ...
                                <div class="mt-5">
                                    <div class="text-xs text-gray-700 space-y-2">
                                        ...
                                        <h6 class="flex items-center space-x-2">
                                            ...
                                            <span><span class="font-medium">Your Time: </span>{{ props.eventDialogData.time.start }}</span>
                                        </h6>
